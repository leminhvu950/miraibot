...
module.exports.languages = {
    "vi": {
        "listAdmin": '====『 𝙰𝚍𝚖𝚒𝚗 』==== \n\n%1\n\n====『 𝚂𝚞𝚙𝚙𝚘𝚛𝚝 』==== \n\n%2',
        "notHavePermssion": '『  』𝙼𝚞𝚊 𝙶𝚘́𝚒 𝙿𝚕𝚊𝚗 𝙲𝚑𝚞̛𝚊 𝙳𝚣𝚊𝚊𝚊 🥹 "%1"',
        "addedNewAdmin": '『 𝚁𝚘𝚢𝚊𝚕 』• 𝚃𝚒𝚎̂́𝚗 𝙷𝚊̀𝚗𝚑 𝚃𝚑𝚊̆𝚗𝚐 𝚀𝚞𝚢𝚎̂̀𝚗 𝙰𝚍𝚖𝚒𝚗\n%2',
        "removedAdmin": '『 𝚁𝚘𝚢𝚊𝚕 』• 𝚃𝚒𝚎̂́𝚗 𝙷𝚊̀𝚗𝚑 𝙷𝚊̣ 𝚀𝚞𝚢𝚎̂̀𝚗 𝙰𝚍𝚖𝚒𝚗\n%2'
    },
    "en": {
...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            if (permssion != 3) return api.sendMessage("『 SinLe 』𝙼𝚞𝚊 𝙶𝚘́𝚒 𝙿𝚕𝚊𝚗 𝙲𝚑𝚞̛𝚊 𝙳𝚣𝚊𝚊𝚊 🥹", threadID, messageID);
        ...
        case 'only': {
            if (permssion != 1) return api.sendMessage("『 SinLe 』𝙼𝚞𝚊 𝙶𝚘́𝚒 𝙿𝚕𝚊𝚗 𝙲𝚑𝚞̛𝚊 𝙳𝚣𝚊𝚊𝚊 🥹", threadID, messageID);
        const { resolve } = require("path");
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("『 𝐙𝐞𝐮𝐬𝚕 』• 𝙾𝙵𝙵 𝙾𝙽𝙻𝚈 𝙱𝙾𝚇", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("『 𝐙𝐞𝐮𝐬 』• 𝙾𝙽 𝙾𝙽𝙻𝚈 𝙱𝙾𝚇", threadID, messageID);
        }
   ...
   case '-o': {
        ...
        if (config.adminOnly == false) {
            ...
            api.sendMessage("『 SinLe 』• 𝙾𝙽 𝙰𝙳𝙼𝙸𝙽 𝙾𝙽𝙻𝚈", threadID, messageID);
        } else {
            config.adminOnly = false;
            api.sendMessage("『 SinLe 』• 𝙾𝙵𝙵 𝙰𝙳𝙼𝙸𝙽 𝙾𝙽𝙻𝚈", threadID, messageID);
        }
            writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
              break;
        }
    ...
    case '-c': {
        ...
        if (config.adminPersonalOnly == false) {
            ...
            api.sendMessage("『 SinLe 』• 𝙾𝙵𝙵 𝙸𝙱𝚁𝙸𝙴𝙽𝙶", threadID, messageID);
        } else {
            config.adminPersonalOnly = false;
            api.sendMessage("『 SinLe 』• 𝙾𝙽 𝙾𝙽𝙻𝚈 𝙱𝙾𝚇", threadID, messageID);
        }
            writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
              break;
        }
